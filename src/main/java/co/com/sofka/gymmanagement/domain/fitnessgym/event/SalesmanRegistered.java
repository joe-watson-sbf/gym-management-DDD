...
public class SalesmanRegistered extends DomainEvent {
    ...
    public SalesmanRegistered(SalesmanId salesmanId, Name name,
                    Gender gender, Email email,
                    PhoneNumber phoneNumber, Address address) {
        super("co.com.sofka.gymmanagement.fitnessgym.salesmanregistered");
