...
public class ScheduleCreated extends DomainEvent {
    ...
    public ScheduleCreated(ScheduleId scheduleId, OpenDay openDay, CloseDay closeDay, OpenHour openHour,
                    PauseHour pauseHour, CloseHour closeHour)
    {
        super("co.com.sofka.gymmanagement.fitnessgym.schedulecreated");
